...
def run_single_experiment(experiment_name, config_overrides, fold):
    ...
    """
    logger.info(f"--- 🚀 开始CASIA实验: {experiment_name} (Fold {fold+1}) ---")
    ...
    if 'NOISY_DATA_DIR' in config_overrides:
        import os
        config_casia.NOISY_FEAT_PATH = os.path.join(config_casia.NOISY_DATA_DIR, "train")
        logger.info(f"  📁 噪声特征路径已更新: {config_casia.NOISY_FEAT_PATH}")
    
    # --- ⚠️ 关键修复1：设置随机种子和环境 ---
    config_casia.setup_environment()
    logger.info(f"  🎲 随机种子已设置: {config_casia.RANDOM_SEED}")

    # --- 运行训练 ---
    import train_CASIA
    importlib.reload(train_CASIA)

    trainer = train_CASIA.FixedCASIACrossDomainTrainer(fold=fold, experiment_name=experiment_name)
...
def main():
    ...
    core_ablations = [
        ...
        #                  'NOISY_DATA_DIR': r"C:\Users\admin\Desktop\DATA\processed_features_CASIA_real_noise\processed_features_babble_0db"}
        # },
        # {
        #     'name': 'emotion2vec+ssl babble 10db',
        #     'settings': {'USE_DACP': False, 'USE_ECDA': False, 'FIXED_CONFIDENCE_THRESHOLD': 0.75, 
        #                  'NOISY_DATA_DIR': r"C:\Users\admin\Desktop\DATA\processed_features_CASIA_real_noise\processed_features_babble_10db"}
        # },
        # {
        #     'name': 'emotion2vec+ssl babble 15db',
        #     'settings': {'USE_DACP': False, 'USE_ECDA': False, 'FIXED_CONFIDENCE_THRESHOLD': 0.75, 
        #                  'NOISY_DATA_DIR': r"C:\Users\admin\Desktop\DATA\processed_features_CASIA_real_noise\processed_features_babble_15db"}
        # },
        # {
        #     'name': 'emotion2vec+ssl babble 20db',
        #     'settings': {'USE_DACP': False, 'USE_ECDA': False, 'FIXED_CONFIDENCE_THRESHOLD': 0.75, 
        #                  'NOISY_DATA_DIR': r"C:\Users\admin\Desktop\DATA\processed_features_CASIA_real_noise\processed_features_babble_20db"}
        # },
        {
            'name': 'emotion2vec+ssl factory 0db',
            'settings': {'USE_DACP': False, 'USE_ECDA': False, 'FIXED_CONFIDENCE_THRESHOLD': 0.75, 
                         'NOISY_DATA_DIR': r"C:\Users\admin\Desktop\DATA\processed_features_CASIA_real_noise\processed_features_factory1_0db"}
        },
        {
            'name': 'emotion2vec+ssl factory 10db',
            'settings': {'USE_DACP': False, 'USE_ECDA': False, 'FIXED_CONFIDENCE_THRESHOLD': 0.75, 
                         'NOISY_DATA_DIR': r"C:\Users\admin\Desktop\DATA\processed_features_CASIA_real_noise\processed_features_factory1_10db"}
        },
        {
            'name': 'emotion2vec+ssl factory 15db',
            'settings': {'USE_DACP': False, 'USE_ECDA': False, 'FIXED_CONFIDENCE_THRESHOLD': 0.75, 
                         'NOISY_DATA_DIR': r"C:\Users\admin\Desktop\DATA\processed_features_CASIA_real_noise\processed_features_factory1_15db"}
        },
        {
            'name': 'emotion2vec+ssl factory 20db',
            'settings': {'USE_DACP': False, 'USE_ECDA': False, 'FIXED_CONFIDENCE_THRESHOLD': 0.75, 
                         'NOISY_DATA_DIR': r"C:\Users\admin\Desktop\DATA\processed_features_CASIA_real_noise\processed_features_factory1_20db"}
        },
        {
            'name': 'emotion2vec+ssl hfchannel 0db',
            'settings': {'USE_DACP': False, 'USE_ECDA': False, 'FIXED_CONFIDENCE_THRESHOLD': 0.75, 
                         'NOISY_DATA_DIR': r"C:\Users\admin\Desktop\DATA\processed_features_CASIA_real_noise\processed_features_hfchannel_0db"}
        },
        {
            'name': 'emotion2vec+ssl hfchannel 10db',
            'settings': {'USE_DACP': False, 'USE_ECDA': False, 'FIXED_CONFIDENCE_THRESHOLD': 0.75, 
                         'NOISY_DATA_DIR': r"C:\Users\admin\Desktop\DATA\processed_features_CASIA_real_noise\processed_features_hfchannel_10db"}
        },
        {
            'name': 'emotion2vec+ssl hfchannel 15db',
            'settings': {'USE_DACP': False, 'USE_ECDA': False, 'FIXED_CONFIDENCE_THRESHOLD': 0.75, 
                         'NOISY_DATA_DIR': r"C:\Users\admin\Desktop\DATA\processed_features_CASIA_real_noise\processed_features_hfchannel_15db"}
        },
        {
            'name': 'emotion2vec+ssl hfchannel 20db',
            'settings': {'USE_DACP': False, 'USE_ECDA': False, 'FIXED_CONFIDENCE_THRESHOLD': 0.75, 
                         'NOISY_DATA_DIR': r"C:\Users\admin\Desktop\DATA\processed_features_CASIA_real_noise\processed_features_hfchannel_20db"}
        },
        {
            'name': 'emotion2vec+ssl volvo 0db',
            'settings': {'USE_DACP': False, 'USE_ECDA': False, 'FIXED_CONFIDENCE_THRESHOLD': 0.75, 
                         'NOISY_DATA_DIR': r"C:\Users\admin\Desktop\DATA\processed_features_CASIA_real_noise\processed_features_volvo_0db"}
        },
        {
            'name': 'emotion2vec+ssl volvo 10db',
            'settings': {'USE_DACP': False, 'USE_ECDA': False, 'FIXED_CONFIDENCE_THRESHOLD': 0.75, 
                         'NOISY_DATA_DIR': r"C:\Users\admin\Desktop\DATA\processed_features_CASIA_real_noise\processed_features_volvo_10db"}
        },
        {
            'name': 'emotion2vec+ssl volvo 15db',
            'settings': {'USE_DACP': False, 'USE_ECDA': False, 'FIXED_CONFIDENCE_THRESHOLD': 0.75, 
                         'NOISY_DATA_DIR': r"C:\Users\admin\Desktop\DATA\processed_features_CASIA_real_noise\processed_features_volvo_15db"}
        },
        {
            'name': 'emotion2vec+ssl volvo 20db',
            'settings': {'USE_DACP': False, 'USE_ECDA': False, 'FIXED_CONFIDENCE_THRESHOLD': 0.75, 
                         'NOISY_DATA_DIR': r"C:\Users\admin\Desktop\DATA\processed_features_CASIA_real_noise\processed_features_volvo_20db"}
        },
        # {
        #     'name': 'without ECDA',
