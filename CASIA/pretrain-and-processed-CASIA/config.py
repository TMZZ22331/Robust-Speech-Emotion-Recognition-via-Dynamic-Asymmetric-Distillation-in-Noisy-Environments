...
class TrainingConfig:
    ...
    # 数据路径配置
    FEAT_PATH = "C:/Users/admin/Desktop/DATA/processed_features_clean/train"
    ...
    # CASIA数据集配置 (更新为完整的英文标签名)
    LABEL_DICT = {'angry': 0, 'happy': 1, 'neutral': 2, 'sad': 3}
    SESSION_SAMPLES = [1499, 1500, 1499, 1498]  # CASIA各说话人样本数 (IEMOCAP:SESSION_SAMPLES = [1085, 1023, 1151, 1031, 1241]，CASIA:SESSION_SAMPLES = [1499, 1500, 1499, 1498] )
